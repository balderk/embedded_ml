...
#define AI_NN2_MODEL_SIGNATURE     "9d5a790bb59ec7f64a9ab5492e71fcf7"
...
#define AI_TOOLS_DATE_TIME   "Fri Feb 28 21:43:43 2020"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 256, 64, 1, 1), AI_STRIDE_INIT(4, 4, 1024, 65536, 65536),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 256, 256, 1, 1), AI_STRIDE_INIT(4, 4, 1024, 262144, 262144),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NN2_OUT_NUM, &dense_3_output),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 339264);
    dense_3_bias_array.data_start = AI_PTR(weights + 339264);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 338240);
    dense_3_weights_array.data_start = AI_PTR(weights + 338240);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 337984);
    dense_2_bias_array.data_start = AI_PTR(weights + 337984);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 272448);
    dense_2_weights_array.data_start = AI_PTR(weights + 272448);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 271424);
    dense_1_bias_array.data_start = AI_PTR(weights + 271424);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 9280);
    dense_1_weights_array.data_start = AI_PTR(weights + 9280);
    dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_bias_array.data = AI_PTR(weights + 8256);
    dense_bias_array.data_start = AI_PTR(weights + 8256);
