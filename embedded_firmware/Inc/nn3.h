...
#define AI_NN3_MODEL_NAME          "nn3"

#define AI_NN3_IN_NUM       (1)
#define AI_NN3_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 8, 1, NULL), \
}
#define AI_NN3_IN_SIZE { \
  (1 * 1 * 8), \
}
#define AI_NN3_IN_1_SIZE  (1 * 1 * 8)
#define AI_NN3_IN_1_SIZE_BYTES  ((1 * 1 * 8) * 4)




#define AI_NN3_OUT_NUM      (1)
#define AI_NN3_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_NN3_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_NN3_OUT_1_SIZE  (1 * 1 * 4)
#define AI_NN3_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 4)
 ...
 * @ref ai_nn3_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_NN3_*
 * defines into file @ref nn3.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
