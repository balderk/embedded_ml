...
#ifndef __AI_RELU_1_NONE_H__
#define __AI_RELU_1_NONE_H__
#pragma once

#include "ai_platform.h"

#define AI_RELU_1_NONE_MODEL_NAME          "relu_1_none"

#define AI_RELU_1_NONE_IN_NUM       (1)
#define AI_RELU_1_NONE_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 8, 1, NULL), \
}
#define AI_RELU_1_NONE_IN_SIZE { \
  (1 * 1 * 8), \
}
#define AI_RELU_1_NONE_IN_1_SIZE  (1 * 1 * 8)
#define AI_RELU_1_NONE_IN_1_SIZE_BYTES  ((1 * 1 * 8) * 4)


#define AI_RELU_1_NONE_OUT_NUM      (1)
#define AI_RELU_1_NONE_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_RELU_1_NONE_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_RELU_1_NONE_OUT_1_SIZE  (1 * 1 * 4)
#define AI_RELU_1_NONE_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup relu_1_none
 ...
 * header generated by the code generation tool. See AI_RELU_1_NONE_*
 * defines into file @ref relu_1_none.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_relu_1_none_forward(
        ai_handle network, const ai_buffer *input);


AI_API_DECLARE_END

#endif /*__AI_RELU_1_NONE_H__*/
