...
#define AI_NN1_IN_1_SIZE  (1 * 1 * 8)
#define AI_NN1_IN_1_SIZE_BYTES  ((1 * 1 * 8) * 4)




#define AI_NN1_OUT_NUM      (1)
#define AI_NN1_OUT { \
...
#define AI_NN1_OUT_1_SIZE  (1 * 1 * 4)
#define AI_NN1_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 4)
 ...
 * @ref ai_nn1_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_NN1_*
 * defines into file @ref nn1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
